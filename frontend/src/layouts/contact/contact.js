      ...
      <div className="container">
        ...
        <Form className="full-width mx-auto pb-4">
          <Col xs={1} md={2} className="mb-3">
            <Row  ><Form.Group className="sm-mb" as={Col} controlId="formGridPassword">
              <Form.Label className="text-white contact">Full Name : </Form.Label>
          ...
          <Form.Group className="mb-3">
            Tell us a few words :           <Form.Control
              as="textarea"
              placeholder=""
              style={{ height: "150px" }}
            />
